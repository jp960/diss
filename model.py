...
class pix2pix(object):
    ...
    def sample_model(self, sample_dir, epoch, idx):
        ...
        save_images(samples, depth_images, [self.sample_size, 1],
                    '/home/janhavi/Documents/diss/train/output1449_24_1000_00005/train_{0}_{1}.png'.format(epoch, int(g_loss)),
                    '/home/janhavi/Documents/diss/train/output1449_24_1000_00005/train_{0}_{1}.txt'.format(epoch, int(g_loss)))
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                if np.mod(counter, 600) == 1:  # change back to 100
