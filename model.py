...
class pix2pix(object):
    ...
    def load_random_samples(self):
        preprocessed_data = np.random.choice(glob('/home/janhavi/Documents/diss2/diss/NYU/preprocessed/*.png'),
                                             self.sample_size)
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            data_pre = sorted(glob('/home/janhavi/Documents/diss2/diss/NYU/preprocessed/*.png'))
            data_depth = sorted(glob('/home/janhavi/Documents/diss2/diss/NYU/depths/*.png'))
